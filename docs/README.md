...
// Хотите использовать async/await? Не проблема! Добавьте "async" - перед вашим методом/функцией,
...
> Обратите внимание, что `URLSearchParams` поддерживается не всеми браузерами (см. [Caniuse.com](http://www.caniuse.com/#feat=urlsearchparams)), но существует [полифилл](https://github.com/WebReflection/url-search-params) 
